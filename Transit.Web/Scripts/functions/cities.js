...
$(document).ready(function () {
    ...
    var jqxhr = $.ajax(
                {
                    type: "get",
                    url: ('/' + citiesURL + 'GetAllCountriesAJAX'),
                })
                    .done(function (data) {
                        debugger;
                        if (data.Successful) {
                            //Countries.push(data.CountriesList);

                            ////$("#selectCountry").autocomplete({
                            ////    select: function (a, b) {
                            ////        debugger;
                            ////    $('#selectCountry').val(b.item.label);
                            ////    return false;
                            ////}
                            ////,source: Countries
                            ////});
    ...
    vehicleTypesTable = $("#CitiesTable").DataTable({
        paging: true,
        sort: true,
        searching: true,
        ajax: {
            url: ('/' + citiesURL + 'GetAllCitiesAJAX'),
            method: 'get',
            dataType: 'json',
            dataSrc: "CitiesList"
        },
